    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<QuizModel>>(
        ...
        builder: (context, snapshot) {
          ...
          if (quizzes.isEmpty) return const Center(child: Text("No quizzes created yet."));
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(16), boxShadow: [BoxShadow(color: Colors.black26.withOpacity(0.1), blurRadius: 8)]),
                child: ListTile(
                  leading: ClipRRect(borderRadius: BorderRadius.circular(10), child: Image.asset(quiz.image, width: 60, height: 60, fit: BoxFit.cover)),
                  title: Text(quiz.title, style: const TextStyle(fontWeight: FontWeight.w600)),
                  subtitle: Text("Deadline: ${quiz.deadline.day}/${quiz.deadline.month}/${quiz.deadline.year}\nQuestions: ${quiz.numQuestions}"),
                ),
              );
            },
          );
